...
public class TradeCaptureConfirm implements BinaryCodec {
  ...
  public static enum ApplExtendMessageFactory {
    ...
    static {
      getInstance().register("031", TradeCaptureConfirmExtend031::new);
      getInstance().register("051", TradeCaptureConfirmExtend051::new);
      getInstance().register("060", TradeCaptureConfirmExtend060::new);
      getInstance().register("061", TradeCaptureConfirmExtend061::new);
      getInstance().register("062", TradeCaptureConfirmExtend062::new);
    }
