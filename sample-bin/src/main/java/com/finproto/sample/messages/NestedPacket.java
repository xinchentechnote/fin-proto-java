...
public class NestedPacket implements BinaryCodec {
    ...
    short subPacketListSize = byteBuf.readShortLE();
        ...
        SubPacket subPacketList_ = new SubPacket();subPacketList_.decode(byteBuf);this.subPacketList.add(subPacketList_);
        }
        }
    ...
    public boolean equals(Object obj) {
        ...
        return Objects.equals(subPacket, orther_.subPacket) && Objects.equals(subPacketList, orther_.subPacketList) && Objects.equals(inerPacket, orther_.inerPacket);
    }
    

    @Override
    public String toString() {
        return "NestedPacket [" + "subPacket=" + this.subPacket + ", subPacketList=" + this.subPacketList + ", inerPacket=" + this.inerPacket + "]";
    }
    ...
    public static class InerPacket implements BinaryCodec {
        ...
        @Override
        public String toString() {
            return "InerPacket [" + "fieldU32=" + this.fieldU32 + ", fieldI16List=" + this.fieldI16List + "]";
        }
