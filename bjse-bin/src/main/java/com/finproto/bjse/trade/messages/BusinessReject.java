...
public class BusinessReject implements BinaryCodec {
  ...
  public void encode(ByteBuf byteBuf) {
    ...
    byteBuf.writeLongLE(this.refSeqNum);
    byteBuf.writeIntLE(this.refMsgType);
    writeFixedString(byteBuf, this.businessRejectRefId, 10);
    byteBuf.writeShortLE(this.businessRejectReason);
  ...
  public void decode(ByteBuf byteBuf) {
    ...
    this.refSeqNum = byteBuf.readLongLE();
    this.refMsgType = byteBuf.readIntLE();
    this.businessRejectRefId = readFixedString(byteBuf, 10);
    this.businessRejectReason = byteBuf.readShortLE();
