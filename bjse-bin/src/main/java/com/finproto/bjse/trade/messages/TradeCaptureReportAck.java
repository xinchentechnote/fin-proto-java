...
public class TradeCaptureReportAck implements BinaryCodec {
  ...
  private byte trdAckStatus;
  private byte trdRptStatus;
  private short tradeReportRejectReason;
  private long lastPx;
  ...
  public byte getTrdAckStatus() {
    return this.trdAckStatus;
  }

  public void setTrdAckStatus(byte trdAckStatus) {
    this.trdAckStatus = trdAckStatus;
  }
  ...
  public void setTrdRptStatus(byte trdRptStatus) {
    this.trdRptStatus = trdRptStatus;
  }

  public short getTradeReportRejectReason() {
    return this.tradeReportRejectReason;
  }

  public void setTradeReportRejectReason(short tradeReportRejectReason) {
  ...
  public void encode(ByteBuf byteBuf) {
    ...
    byteBuf.writeByte(this.trdAckStatus);
    byteBuf.writeByte(this.trdRptStatus);
    byteBuf.writeShortLE(this.tradeReportRejectReason);
  ...
  public void decode(ByteBuf byteBuf) {
    ...
    this.trdAckStatus = byteBuf.readByte();
    this.trdRptStatus = byteBuf.readByte();
    this.tradeReportRejectReason = byteBuf.readShortLE();
  ...
  public boolean equals(Object obj) {
    ...
    TradeCaptureReportAck orther_ = (TradeCaptureReportAck) obj;
    return Objects.equals(partitionNo, orther_.partitionNo)
        ...
        && Objects.equals(tradeReportRefId, orther_.tradeReportRefId)
        && Objects.equals(trdAckStatus, orther_.trdAckStatus)
        && Objects.equals(trdRptStatus, orther_.trdRptStatus)
        && Objects.equals(tradeReportRejectReason, orther_.tradeReportRejectReason)
  ...
  public String toString() {
    return "TradeCaptureReportAck ["
        ...
        + ", tradeReportRefId="
        + this.tradeReportRefId
        + ", trdAckStatus="
        + this.trdAckStatus
        + ", trdRptStatus="
        + this.trdRptStatus
        + ", tradeReportRejectReason="
        + this.tradeReportRejectReason
        + ", lastPx="
        + this.lastPx
        + ", lastQty="
        + this.lastQty
  ...
  public static enum ApplExtendMessageFactory {
    ...
    static {
      getInstance().register("031", TradeCaptureReportAckExtend031::new);
      getInstance().register("051", TradeCaptureReportAckExtend051::new);
      getInstance().register("060", TradeCaptureReportAckExtend060::new);
      getInstance().register("061", TradeCaptureReportAckExtend061::new);
      getInstance().register("062", TradeCaptureReportAckExtend062::new);
    }
