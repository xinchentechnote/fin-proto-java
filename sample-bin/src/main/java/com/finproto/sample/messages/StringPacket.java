...
public class StringPacket implements BinaryCodec {
  ...
  public void decode(ByteBuf byteBuf) {
    ...
    if (fieldDynamicStringLen > 0) {
      this.fieldDynamicString =
          byteBuf.readCharSequence(fieldDynamicStringLen, StandardCharsets.UTF_8).toString();
    }
    short fieldDynamicString1Len = byteBuf.readShortLE();
    if (fieldDynamicString1Len > 0) {
      this.fieldDynamicString1 =
          byteBuf.readCharSequence(fieldDynamicString1Len, StandardCharsets.UTF_8).toString();
    }
    ...
    if (fieldDynamicStringListSize > 0) {
      ...
      for (int i = 0; i < fieldDynamicStringListSize; i++) {
        ...
        if (fieldDynamicStringListLen > 0) {
          this.fieldDynamicStringList.add(
              byteBuf
                  .readCharSequence(fieldDynamicStringListLen, StandardCharsets.UTF_8)
                  .toString());
        }
      }
    }
    ...
    if (fieldDynamicString1ListSize > 0) {
      ...
      for (int i = 0; i < fieldDynamicString1ListSize; i++) {
        ...
        if (fieldDynamicString1ListLen > 0) {
          this.fieldDynamicString1List.add(
              byteBuf
                  .readCharSequence(fieldDynamicString1ListLen, StandardCharsets.UTF_8)
                  .toString());
        }
      }
    }
  ...
  public boolean equals(Object obj) {
    ...
    return Objects.equals(fieldDynamicString, orther_.fieldDynamicString)
